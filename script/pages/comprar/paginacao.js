const listaDeCarrosParaTeste = [
    new Car("Mitsubishi", "Eclipse", "Sedan", "Branca", "93YZZZ765BT014588", "AAA1A11", 2019, 2020, 50000, "1.5 Turbo", 125000, "Automático", 4, true, true, true, true, true, true, true, true, true, "Couro", true, true),

    new Car("Hyundai", "HB20", "Sedan", "Cinza", "9BWZZZ377VT004251","ABA1A11", 2020, 2021, 45000, "1.6 Flex", 65000, "Automático", 3, true, true, true, true, true, false, true, true, true, "Tecido", true, true),

    new Car("Chevrolet", "Astra", "Hatch", "Prata", "9BGZZZ123ST065487", "ABB1A11", 2011, 2012, 120000, "2.0 Flex", 35000, "Manual", 3, true, true, true, true, true, false, false, false, true, "Tecido", true, false),

    new Car("Toyota", "Corolla", "Sedan", "Branco", "9BRZZZ377JT054871", "ABB2A11", 2020, 2021, 38000, "2.0 Flex", 115000, "Automático", 2, true, true, true, true, true, true, true, true, true, "Couro", true, true),

    new Car("Renault", "Duster", "SUV", "Prata", "93YZZZ765BT014587", "ABB2B11", 2019, 2020, 60000, "1.6 Flex", 78000, "Manual", 4, true, true, true, true, true, false, true, true, true, "Tecido", true, false),

    new Car("Ford", "Ka", "Preto", "Hatch", "9FDZZZ347FT008911","ABB2B21", 2012, 2012, 95000, "1.0 Flex", 29000, "Manual", 2, true, true, true, true, false, false, false, false, true, "Tecido", true, false),
    ...
    new Car("Fiat", "Cronos", "Branco", "Sedan", "9BDZZZ1GZKW123456", "AAA1A13", 2022, 2023, 25000, "1.3 Flex", 85000, "Manual", 2, true, true, true, true, true, true, true, true, true, "Tecido", true, true),

    new Car("BMW", "M6", "Azul", "Sedan", "WBSZZZ987HT034113", "AAA1A34", 2022, 2023, 15000, "4.4 V8 Twin Turbo", 780000, "Automático", 2, true, true, true, true, true, true, true, true, true, "Couro", true, true),

    new Car("Porsche", "Taycan", "SUV", "Branco", "WP0ZZZJ123A045891", "DAA1A11", 2023, 2024, 5000, "Elétrico 761cv", 1100000, "Automático", 4, true, true, true, true, true, true, true, true, true, "Couro", true, true),

    new Car("Honda", "Civic Type R","Hatch", "Branco", "8ADZZZ478KT009322", "EAA1A11", 2023, 2024, 8000, "2.0 Turbo 310cv", 310000, "Manual", 2, true, true, true, true, true, true, true, true, true, "Couro", true, true),
